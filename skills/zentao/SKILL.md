---
name: zentao
description: 通过禅道 Bug ID 或禅道 Bug 详情页 URL 抓取 Bug 详情并输出 Markdown；也支持按指派者/解决者/解决日期范围搜索 Bug。用于查看 bug 详情、分析 bug 上下文、编写 git commit message，以及整理周报/月报。适用于“提取禅道 bug”“根据 bug 链接抓详情”“导出 bug 描述”“分析某个 bug”“根据 bug 信息组织提交说明”“按条件搜索 bug”“按时间范围统计已解决问题”等请求。
---
